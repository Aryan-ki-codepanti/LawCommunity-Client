...
<!-- hero -->
<?php
          $heading = "policy and ammendments";
          $subTitle = "Learn about Policies and ammendments that makes you aware about the legal system .";
          $btnTxt = "Read Policy & Judgements";
        ...
        <div class="row">
            ...
            <div class="col-lg-10 col-sm-12 d-flex justify-content-center">
                <div class="d-flex flex-wrap justify-content-center justify-content-lg-start">
                    ...
                    $policies = mysqli_query($conn , "SELECT * FROM `$table` ORDER BY id DESC;");
                    ...
                    foreach($policies as $policy){
                        ...
                        if (empty(trim($policy["image"]))){
                            ...
                            $html = $html . '<div class="rounded-10 mx-auto mt-2"
                                style="background-image: url(../admin/img/policies_amendments/'. $policy["image"] .'); background-position: center; background-size: cover; width: 90%; height: 45%; filter: drop-shadow(0px 4px 100px rgba(0, 0, 0, 0.2)); ">
                            </div>
                            ';    
                        }
                        ...
                        $html = $html . '
                                <div class="p-2">
                                    <p class="lead text-orange fw-bolder">'.$policy["heading"].'</p>
                                    <p class="lead text-dark fw-bolder fs-base">'.$policy["subheading"].'</p>
                                </div>
