...
<!-- hero -->
<?php
          $heading = "Legal internships";
          $subTitle = "Looking for a professional experience now find best internship opportunities available";
          $btnTxt = "Post an Internship";
          $btnTextColor = "text-red";

          $feaureTitle1 = "Real Time ";
          $feaureTitle2 = "Specific";
          $feaureTitle3 = "Genuine";
          $feaureTitle4 = "Easy ";

          $featureSubtitle1 = "Updates";
          $featureSubtitle2 = "Categories";
          $featureSubtitle3 = "Organizations";
...
<section class="py-15 pb-5">
    <div class="container">
            ...
            <div class="col-lg-6 col-md-6 col-sm-12">
                <div class="d-flex justify-content-center">
                  <a href="jobs.php" class="d-flex justify-content-center">
                    <img src="../assets/images/icons/chat-right-dots-white.svg" alt="" style="width: 40px; margin-right: 20px;">
                    <span class="lead fw-bold text-white fs-4">Jobs</span>
                  </a>
                </div>
            </div>
            <div class="col-lg-6 col-md-6 col-sm-12 mt-5 mt-lg-0">
                <div class="d-flex justify-content-center">
                  <a href="internships.php" class="d-flex justify-content-center">
                    <img src="../assets/images/icons/internships.svg" alt="" style="width: 40px; margin-right: 20px;">
                    <span class="lead fw-bold text-orange fs-4">Internships</span>
                  </a>
                </div>
            </div>
        </div>
        ...
        <hr style="height: 3px;">
        <br>
        <p class="lead text-white text-center">Employment or professional growth avenue from whole country, details available for Legal Professionals and Law Students</p>
    </div>
</section>
    ...
    <div class="container mt-5 mt-xl-10">
      <div class="row justify-content-center mb-5 mb-xl-10">
        <div class="col-lg-12 text-center">
          ...
          <button class="btn btn-filter rounded-pill mt-2" data-filter=".filter-virtual" data-target="#grid1">Virtual</button>
          <button class="btn btn-filter rounded-pill mt-2" data-filter=".filter-lawfirm" data-target="#grid1">Law Firm</button>
          <button class="btn btn-filter rounded-pill mt-2" data-filter=".filter-corporate" data-target="#grid1">Corporate</button>
          <button class="btn btn-filter rounded-pill mt-2" data-filter=".filter-advocate" data-target="#grid1">Advocate</button>
          <button class="btn btn-filter rounded-pill mt-2" data-filter=".filter-ngo" data-target="#grid1">NGO</button>
      ...
      <div class="row g-1" id="grid1" data-isotope="" style="position: relative; height: 1251px;">
        ...
        <div class="col-12 filter-lawfirm" style="position: absolute; left: 0px; top: 139px;">
        ...
        <div class="col-12 filter-advocate" style="position: absolute; left: 0px; top: 139px;">
          <a href="" class="card bg-new" style="border-radius: 10px;">
            <div class="card-body">
              <div class="row d-flex align-items-center g-2 g-md-4 text-center text-md-start">
                <div class="col-md-2 col-lg-2">
        ...
        <div class="col-12 filter-virtual" style="position: absolute; left: 0px; top: 139px;">
          <a href="" class="card bg-new" style="border-radius: 10px;">
            <div class="card-body">
              <div class="row d-flex align-items-center g-2 g-md-4 text-center text-md-start">
                <div class="col-md-2 col-lg-2">
        ...
        <div class="col-12 filter-ngo" style="position: absolute; left: 0px; top: 139px;">
          <a href="" class="card bg-new" style="border-radius: 10px;">
            <div class="card-body">
              <div class="row d-flex align-items-center g-2 g-md-4 text-center text-md-start">
                <div class="col-md-2 col-lg-2">
...
<?php
          ...
          $collaborationBtn = "Post Internship";
